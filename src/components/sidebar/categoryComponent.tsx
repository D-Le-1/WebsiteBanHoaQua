const CategoryComponent = ({ name }) => {
    return (
      <div className="w-24 h-32 border border-gray-200 shadow-sm rounded-lg p-2 bg-emerald-50 hover:shadow-md hover:border-orange-300 transition-all duration-300 flex flex-col items-center justify-center group">
